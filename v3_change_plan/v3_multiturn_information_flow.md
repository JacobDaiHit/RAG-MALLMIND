...
> **历史演练稿，示例字段不等于当前 wire schema（2026-07-18 已标注）。** 当前多轮状态如何传递、
> `product/explore` 怎样切换、商品卡与购物车序号怎样区分，均以根目录 `README.md` 的“多轮对话怎样连接”
> 章节和 `v3_implementation_execution_log.md` 为准。
